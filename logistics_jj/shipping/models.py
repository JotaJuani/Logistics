...
class ShippingRequest(models.Model):
    ...
    peso = models.DecimalField("Peso (kg)", max_digits=10, decimal_places=2, default=0.0)
    largo = models.DecimalField("Largo (cm)", max_digits=10, decimal_places=2, default=0.0)
    ancho = models.DecimalField("Ancho (cm)", max_digits=10, decimal_places=2, default=0.0)
    alto = models.DecimalField("Alto (cm)", max_digits=10, decimal_places=2, default=0.0)
